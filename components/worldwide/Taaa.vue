<template>
  <BModal v-model:show="show_goal17" id="modal-tall" class="model-xl">
    <section class="topic lightbox worldwide-goal" :id="`worldwide-goal-${data[idx].id}`">
      ...
      <nav class="pagination d-flex-row-center w-full z-index-1">
        ...
        <div class="page btn wwg-page d-iflex-column-center w-full fc-secondary" v-for="(page, index) in 17" :key="page"
