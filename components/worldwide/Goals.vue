<template>
  <section class="topic" id="worldwide">
    <header class="topic-header">
      <p class="no">01</p>
      <h2 class="heading"><span class="heading-ch">全球SDGs進度表：誰在落後清單上？</span><br />
    ...
    <div class="inline">
      <div class="inline-text ww-inline-text pos-lg-absolute w-lg-50">
        ...
        <p>從聯合國最新報告《The Sustainable Development Goals Report 2024》，揭示全球17項的永續目標進展中，單項最高達成率（On track or target
          met）僅約40%，分別為SDG7可負擔的永續能源、SDG12責任消費與生產。透過此區塊的視覺設計，一起掌握哪些永續項目岌岌可危。</p>
        <button class="btn btn-white btn-more" @click="show_goal17 = true">點按看進度</button>
      </div>
