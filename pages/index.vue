<template>
  <section class="hero" id="hero">
    <div class="container gsap-scroll-hero">
      <div
        class="hero-part hero-part-1 pos-absolute d-flex flex-row align-items-center"
      >
        ...
        <picture>
          <source
            ...
            srcset="/images/bg-SDGs.webp"
            media="(min-width: $tab-max)"
            type="image/webp"
          />
          <source
            class="bg-main-visual"
            srcset="/images/bg-SDGs-vert.svg"
            media="(max-width: 1023.9px)"
            type="image/svg+xml"
          />
          <img
            class="bg-main-visual"
            src="/images/bg-SDGs.webp"
            alt="main-visual"
          />
        </picture>
      </div>
