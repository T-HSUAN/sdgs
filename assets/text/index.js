...
export const data_sdgs_aspect = [
  { id: 1, aspect: "環境面", label: [6, 13, 14, 15] },
  { id: 2, aspect: "社會面", label: [1, 2, 3, 4, 5, 7, 11, 16] },
  { id: 3, aspect: "經濟面", label: [8, 9, 10, 12] },
  { id: 4, aspect: "夥伴關係", label: [17] }
]
...
export const data_articles = [
  ...
  },
  {
    ...
    aspect: 3,
    abstract: "地球的海洋孕育了無數生命，也維繫著全球氣候與人類經濟。SDG 14「保育海洋生態」呼籲各國重視海洋污染、過度捕撈與珊瑚白化等危機。推動海洋保護區、禁止一次性塑膠製品與落實漁業管理，是目前最迫切的任務。海洋不只是資源庫，更是我們生存的關鍵環境。",
    img: "article3-1.png",
  },
  {
    id: 4,
    title: "SDG 5：性別平等",
    aspect: 4,
    abstract: "性別平等不僅是人權的基本要求，也是可持續發展的基石。SDG 5「性別平等」強調消除對女性的歧視與暴力，並促進女性在經濟、政治與社會生活中的全面參與。從教育到職場，打破性別刻板印象，讓每個人都能在平等的環境中發揮潛力，是我們共同的責任。",
    img: "article4-1.png",
  },
  // {
  //   id: 5,
