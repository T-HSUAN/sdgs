export const data_hero_part2 = [
  ...
  "在2025年，也是SDGs發布十周年之際，聯合線上《倡議家》發起「SDGs十周年：找回我們失去的進度」數位專題，探究距離2030僅剩5年，我們是否有能力在倒數的每一天，一起找回失去的進度？"
];
...
export const data_sdgs_headings = ['消除貧窮', '終結飢餓', '健康與福祉', '優質教育', '性別平等', '淨水與衛生', '可負擔的永續能源', '就業與經濟成長', '永續工業與基礎建設', '消彌不平等', '永續城鄉', '責任消費與生產', '氣候行動', '永續海洋與保育', '陸域生態', '制度的正義與和平', '永續發展夥伴關係'];
